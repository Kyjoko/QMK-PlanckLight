 ...
 * |------+------+------+------+------+--------|------+------+------+------+------+----------|
 * |      | MU-MOD| AU-ON |AU-OFF| MI-ON|MI-OFF|MU-ON |MU-OFF|MU-VOL-|MU-VOL+| HUE+  | HUE-  |
 * |------+------+------+------+------+------+------+------+------+------+------+------------|
 * |      |       |       |      |      |             |      |  <-   |   ^   |   v   |  ->   |
 * `---------------------------------------------------------------------------------------'
 */
...
[_ADJUST] = LAYOUT_planck_mit(
  ...
  _______,  _______, _______, _______, _______, KC_ACL0, _______,  KC_MS_LEFT, KC_MS_UP, KC_MS_DOWN, KC_MS_RIGHT
),
...
const uint16_t PROGMEM ledcolors[][DRIVER_LED_TOTAL][3] = {
  ...
  [_ADJUST] = {
    ...
    {210,255,1}, {210,255,1}, {210,255,1}, {160, 255, 4}, {160, 255, 4}, {210,255,1}, {210,255,1}, {210,255,1}, {160, 255, 4}, {210,255,1}, {210,255,1}, {210,255,1}, {210,255,1}
  },
