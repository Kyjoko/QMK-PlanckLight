...
/*#define MUSIC_ON_SONG SONG(IMPERIAL_MARCH)
#define MUSIC_OFF_SONG SONG(IMPERIAL_MARCH)

#define MUSIC_ON_SONG SONG(ZELDA_PUZZLE)
#define MUSIC_OFF_SONG SONG(ZELDA_PUZZLE)

#define MUSIC_ON_SONG SONG(MARIO_MUSHROOM)
#define MUSIC_OFF_SONG SONG(MARIO_MUSHROOM)

#define MUSIC_ON_SONG SONG(NUMBER_ONE)
#define MUSIC_OFF_SONG SONG(NUMBER_ONE)*/
